...
async def start(client, message):
    ...
    starttext = f"`Hello, {firstname} ! Nice To Meet You, Well I Am {bot_name}, An Powerfull Bot To  Do Many Things For My Master king!`. \n\nPowered By [Friday Userbot](t.me/FridayOT)"
    ...
    if user_id not in all_user_s:
        await client.send_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("😎 Join My Group 😎", url="https://t.me/cinemahub_boss")]]
            ),
        )
